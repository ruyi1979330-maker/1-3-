        ...
        (function() {
            ...
            for (const key in fieldMap) {
                ...
                for (let i = 0; i < inputs.length; i++) {
                    const el = inputs[i];
                    const parent = el.closest("tr, .form-item, .field-item, label, div");
                    if (!parent) continue;
            ...
            return filledCount + pumpCheckedCount;
        })();
        """.trimIndent()
    }
            ...
            groups.forEach(group => {
                ...
                for (const key in fieldNameMap) {
                    ...
                    for (let i = 0; i < inputs.length; i++) {
                        ...
                        if (!parent) continue;
                        const labelText = parent.textContent.trim();
                        if (labelText.includes(fullFieldName)) {
