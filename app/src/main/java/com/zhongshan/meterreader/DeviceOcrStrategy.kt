...
object DeviceOcrStrategy {
    ...
    // ===================== 绝对坐标（基于3000×4000黑边原图） =====================
    // 特灵1# 蒸发器
    private val screw1Evaporator = listOf(
        HardcodedRoi(0.8197f, 0.3783f, 0.1422f, 0.0275f, "field_1_01|1#蒸发器进口水温", "蒸发器进水温度"),
        HardcodedRoi(0.8363f, 0.4315f, 0.1258f, 0.0280f, "field_1_02|1#蒸发器出口水温", "蒸发器出水温度"),
        HardcodedRoi(0.7270f, 0.5378f, 0.2483f, 0.0313f, "field_1_05|1#蒸发器冷媒压力", "蒸发器制冷剂压力"),
        HardcodedRoi(0.8373f, 0.4845f, 0.1236f, 0.0290f, "field_1_06|1#蒸发器蒸发温度", "蒸发器制冷剂饱和温度")
    )

    // 特灵1# 冷凝器
    private val screw1Condenser = listOf(
        HardcodedRoi(0.8177f, 0.3775f, 0.1516f, 0.0298f, "field_1_08|1#冷凝器进口水温", "冷凝器回水温度"),
        HardcodedRoi(0.8177f, 0.4323f, 0.1493f, 0.0265f, "field_1_09|1#冷凝器出口水温", "冷凝器出水温度"),
        HardcodedRoi(0.7270f, 0.5378f, 0.2472f, 0.0313f, "field_1_12|1#冷凝器冷媒压力", "冷凝器制冷剂压力"),
        HardcodedRoi(0.8143f, 0.4853f, 0.1520f, 0.0298f, "field_1_13|1#冷凝器冷凝温度", "冷凝器制冷剂饱和温度")
    )

    // 特灵1# 压缩机
    private val screw1Compressor = listOf(
        HardcodedRoi(0.7300f, 0.3770f, 0.2486f, 0.0323f, "field_1_14|1#压缩机油压", "油压"),
        HardcodedRoi(0.8167f, 0.4850f, 0.1467f, 0.0280f, "field_1_15|1#压缩机排出口温度", "压缩机排出端冷剂温度"),
        HardcodedRoi(0.4853f, 0.5888f, 0.5216f, 0.0305f, "field_1_18|1#主机负载", "%RLA"),
        HardcodedRoi(0.4643f, 0.6443f, 0.5357f, 0.0283f, "field_1_17|1#电机电流", "电流L1 L2 L3")
    )
    ...
    private val screw3_1_abs = listOf(
        HardcodedRoi(0.8113f, 0.5828f, 0.0897f, 0.0203f, "field_3_02|1#蒸发器出口水温", "冷冻水温度 出水"),
        HardcodedRoi(0.8113f, 0.6063f, 0.0907f, 0.0203f, "field_3_01|1#蒸发器进口水温", "冷冻水温度 返回"),
        HardcodedRoi(0.7500f, 0.8423f, 0.1177f, 0.0195f, "field_3_05|1#蒸发器蒸发压力", "蒸发压力"),
        HardcodedRoi(0.7510f, 0.8655f, 0.1187f, 0.0198f, "field_3_06|1#蒸发器蒸发温度", "蒸发器饱和温度"),
        HardcodedRoi(0.1417f, 0.5805f, 0.0873f, 0.0188f, "field_3_09|1#冷凝器出口水温", "冷却水温度 出水"),
        HardcodedRoi(0.1417f, 0.6023f, 0.0863f, 0.0213f, "field_3_08|1#冷凝器进口水温", "冷却水温度 返回"),
        HardcodedRoi(0.2707f, 0.8383f, 0.1147f, 0.0195f, "field_3_12|1#冷凝器冷凝压力", "冷凝器压力"),
        HardcodedRoi(0.2717f, 0.8603f, 0.1137f, 0.0203f, "field_3_13|1#冷凝器冷凝温度", "冷凝器饱和温度"),
        HardcodedRoi(0.8487f, 0.4485f, 0.0917f, 0.0195f, "field_3_16|1#压缩机排口温度", "压缩机出口温度"),
        HardcodedRoi(0.8500f, 0.5243f, 0.0667f, 0.0203f, "field_3_17|1#压缩机导液开度", "滑阀位置"),
        HardcodedRoi(0.2790f, 0.4530f, 0.1167f, 0.0180f, "field_3_14|1#压缩机油压", "油压差"),
        HardcodedRoi(0.2790f, 0.4735f, 0.0853f, 0.0195f, "field_3_15|1#压缩机油箱温度", "油温")
    )
    ...
    private val absoluteConfigs: Map<String, List<HardcodedRoi>> = run {
        ...
        // 特灵2#：偏移数字+30，并将标签中的"1#"替换为"2#"
        map["screw_2_0"] = screw1Evaporator.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        map["screw_2_1"] = screw1Condenser.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        map["screw_2_2"] = screw1Compressor.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        // 特灵3#：偏移+50，标签替换为"3#"
        map["screw_3_0"] = screw1Evaporator.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 50, "1#", "3#")) }
        map["screw_3_1"] = screw1Condenser.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 50, "1#", "3#")) }
        map["screw_3_2"] = screw1Compressor.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 50, "1#", "3#")) }
        map["cent_1_0"] = yorkCentrifugal
        map["screw_3_1_0"] = screw3_1_abs
        // 约克螺杆2#：偏移+30，标签"1#"换成"2#"
        map["screw_3_2_0"] = screw3_1_abs.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        map
    }
    ...
    private val relativeConfigs: Map<String, List<RoiRelative>> = run {
        ...
        map["screw_2_0"] = screw1EvapRel.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        map["screw_2_1"] = screw1CondRel.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        map["screw_2_2"] = screw1CompRel.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        map["screw_3_0"] = screw1EvapRel.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 50, "1#", "3#")) }
        map["screw_3_1"] = screw1CondRel.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 50, "1#", "3#")) }
        map["screw_3_2"] = screw1CompRel.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 50, "1#", "3#")) }
        map["cent_1_0"] = centRel
        map["screw_3_1_0"] = screw3_1_rel
        map["screw_3_2_0"] = screw3_1_rel.map { it.copy(fieldId = shiftIdAndLabel(it.fieldId, 30, "1#", "2#")) }
        map
    }
    ...
    private fun shiftIdAndLabel(compoundId: String, offset: Int, oldPrefix: String, newPrefix: String): String {
