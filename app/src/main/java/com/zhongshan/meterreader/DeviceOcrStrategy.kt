	...
	object DeviceOcrStrategy {
	    ...
	    private val screw1EvapRel = listOf(
	        ...
	        RoiRelative(0.6800f, 0.3705f, 0.9491f, 0.4218f, "field_1_02|蒸发器出口水温", "蒸发器出水温度"),
	    ...
	    private val screw1CompRel = listOf(
	        ...
	        // 修复：左边界从 0.4542f 右移至 0.4800f，避免截到左侧的干扰字符 "2"
	        RoiRelative(0.4800f, 0.7580f, 0.6000f, 0.8095f, "field_1_17|电机电流", "电流L1 L2 L3")
	    )
	    private val centRel = listOf(
	        RoiRelative(0.2500f, 0.1500f, 0.3800f, 0.2100f, "field_1_76|压缩机排气温度", "压缩机出口温度"),
	        // 屏蔽：RoiRelative(0.2570f, 0.2040f, 0.3308f, 0.2410f, "field_1_82|压缩机导液开度", "%满载安培"),
	        RoiRelative(0.8000f, 0.1300f, 0.9500f, 0.1900f, "field_1_75|压缩机油箱温度", "油槽温度"),
	        ...
	        RoiRelative(0.8300f, 0.3500f, 0.9500f, 0.4100f, "field_1_69|蒸发器出口水温", "冷冻水温度 出水"),
	    ...
	    private val screw3_1_rel = listOf(
	        ...
	        RoiRelative(0.8800f, 0.1560f, 0.9500f, 0.1900f, "field_3_16|压缩机排口温度", "压缩机出口温度"),
