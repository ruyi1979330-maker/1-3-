...
object DeviceOcrStrategy {
    ...
    private val centRel = listOf(
        ...
        RoiRelative(0.2570f, 0.2040f, 0.3308f, 0.2410f, "field_1_82|压缩机导液开度", "%满载安培"),
        // 右上角
        ...
        RoiRelative(0.8460f, 0.4050f, 0.9420f, 0.4400f, "field_1_68|蒸发器进口水温", "冷冻水温度 返回"),
        // 底部左侧 冷凝器
        ...
        // 底部右侧 蒸发器
        RoiRelative(0.7830f, 0.9040f, 0.9100f, 0.9410f, "field_1_78|蒸发器冷媒压力", "蒸发器压力"),
        RoiRelative(0.7820f, 0.9480f, 0.9090f, 0.9856f, "field_1_70|蒸发器蒸发温度", "蒸发器饱和温度")
    )
    ...
    private val screw3_1_rel = listOf(
        ...
        // 右上角
        // 修复：日志显示该区域裁切到了下一行的数字6（62:7\n6），故上移Y轴下边界从0.1840f至0.1720f，避免多行拼接
        RoiRelative(0.8800f, 0.1470f, 0.9500f, 0.1720f, "field_3_16|压缩机排口温度", "压缩机出口温度"),
