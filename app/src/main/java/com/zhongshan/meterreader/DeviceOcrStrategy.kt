...
object DeviceOcrStrategy {
    ...
    private val screw1EvapRel = listOf(
        RoiRelative(0.62f, 0.23f, 0.95f, 0.33f, "field_1_01|蒸发器进口水温", "蒸发器进水温度"),
        RoiRelative(0.62f, 0.35f, 0.95f, 0.45f, "field_1_02|蒸发器出口水温", "蒸发器出水温度"),
        RoiRelative(0.62f, 0.47f, 0.95f, 0.57f, "field_1_06|蒸发器蒸发温度", "蒸发器制冷剂饱和温度"),
        RoiRelative(0.58f, 0.59f, 0.95f, 0.70f, "field_1_05|蒸发器冷媒压力", "蒸发器制冷剂压力")
    )

    private val screw1CondRel = listOf(
        RoiRelative(0.62f, 0.23f, 0.95f, 0.33f, "field_1_08|冷凝器进口水温", "冷凝器回水温度"),
        RoiRelative(0.62f, 0.35f, 0.95f, 0.45f, "field_1_09|冷凝器出口水温", "冷凝器出水温度"),
        RoiRelative(0.62f, 0.47f, 0.95f, 0.57f, "field_1_13|冷凝器冷凝温度", "冷凝器制冷剂饱和温度"),
        RoiRelative(0.58f, 0.59f, 0.95f, 0.70f, "field_1_12|冷凝器冷媒压力", "冷凝器制冷剂压力")
    )

    private val screw1CompRel = listOf(
        RoiRelative(0.05f, 0.23f, 0.40f, 0.35f, "field_1_14|压缩机油压", "油压"),
        RoiRelative(0.58f, 0.47f, 0.95f, 0.57f, "field_1_15|压缩机排出口温度", "压缩机排出端冷剂温度"),
        RoiRelative(0.35f, 0.63f, 0.70f, 0.76f, "field_1_18|主机负载", "%RLA"),
        RoiRelative(0.35f, 0.78f, 0.72f, 0.91f, "field_1_17|电机电流", "电流L1 L2 L3")
    )
