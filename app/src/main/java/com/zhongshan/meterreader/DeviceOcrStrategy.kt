...
object DeviceOcrStrategy {
    ...
    private val screw1EvapRel = listOf(
        RoiRelative(0.7200f, 0.1100f, 0.9400f, 0.1900f, "field_1_01|蒸发器进口水温", "蒸发器进水温度"),
        // 左边界充分左移，确保数字7完整纳入
        RoiRelative(0.7200f, 0.2100f, 0.9400f, 0.2900f, "field_1_02|蒸发器出口水温", "蒸发器出水温度"),
        RoiRelative(0.7200f, 0.3100f, 0.9400f, 0.3900f, "field_1_06|蒸发器蒸发温度", "蒸发器制冷剂饱和温度"),
        RoiRelative(0.6200f, 0.4100f, 0.9500f, 0.4900f, "field_1_05|蒸发器冷媒压力", "蒸发器制冷剂压力")
    )

    private val screw1CondRel = listOf(
        RoiRelative(0.7200f, 0.1100f, 0.9400f, 0.1900f, "field_1_08|冷凝器进口水温", "冷凝器回水温度"),
        RoiRelative(0.7200f, 0.2100f, 0.9400f, 0.2900f, "field_1_09|冷凝器出口水温", "冷凝器出水温度"),
        RoiRelative(0.7200f, 0.3100f, 0.9400f, 0.3900f, "field_1_13|冷凝器冷凝温度", "冷凝器制冷剂饱和温度"),
        RoiRelative(0.6200f, 0.4100f, 0.9500f, 0.4900f, "field_1_12|冷凝器冷媒压力", "冷凝器制冷剂压力")
    )

    private val screw1CompRel = listOf(
        RoiRelative(0.6200f, 0.1100f, 0.9500f, 0.1900f, "field_1_14|压缩机油压", "油压"),
        RoiRelative(0.7200f, 0.3100f, 0.9400f, 0.3900f, "field_1_15|压缩机排出口温度", "压缩机排出端冷剂温度"),
        // 仅框选第一个负载数值
        RoiRelative(0.4000f, 0.5100f, 0.5400f, 0.5900f, "field_1_18|主机负载", "%RLA"),
        // 仅框选L1电流数值
        RoiRelative(0.3800f, 0.6100f, 0.5200f, 0.6900f, "field_1_17|电机电流", "电流L1 L2 L3")
    )

    private val centRel = listOf(
        // 左上角
        RoiRelative(0.2400f, 0.1000f, 0.3800f, 0.1500f, "field_1_76|压缩机排气温度", "压缩机出口温度"),
        RoiRelative(0.2400f, 0.1500f, 0.3400f, 0.2000f, "field_1_82|压缩机导液开度", "%满载安培"),
        // 右上角
        RoiRelative(0.7600f, 0.1000f, 0.9200f, 0.1500f, "field_1_75|压缩机油箱温度", "油槽温度"),
        RoiRelative(0.7600f, 0.1500f, 0.9200f, 0.2000f, "field_1_74|压缩机油泵压力", "油压"),
        // 左中 冷却水
        RoiRelative(0.0800f, 0.3200f, 0.2000f, 0.3700f, "field_1_71|冷凝器出口水温", "冷却水温度 出水"),
        RoiRelative(0.0800f, 0.3700f, 0.2000f, 0.4200f, "field_1_79|冷凝器进口水温", "冷却水温度 返回"),
        // 右中 冷冻水
        RoiRelative(0.7600f, 0.3200f, 0.9200f, 0.3700f, "field_1_69|蒸发器出口水温", "冷冻水温度 出水"),
        RoiRelative(0.7600f, 0.3700f, 0.9200f, 0.4200f, "field_1_68|蒸发器进口水温", "冷冻水温度 返回"),
        // 底部左侧 冷凝器
        RoiRelative(0.2400f, 0.7200f, 0.4000f, 0.7700f, "field_1_77|冷凝器冷媒压力", "冷凝器压力"),
        RoiRelative(0.2400f, 0.7700f, 0.4000f, 0.8200f, "field_1_81|冷凝器冷凝温度", "冷凝器饱和温度"),
        // 底部右侧 蒸发器
        RoiRelative(0.6400f, 0.7200f, 0.9200f, 0.7700f, "field_1_78|蒸发器冷媒压力", "蒸发器压力"),
        RoiRelative(0.6400f, 0.7700f, 0.9200f, 0.8200f, "field_1_70|蒸发器蒸发温度", "蒸发器饱和温度")
    )

    private val screw3_1_rel = listOf(
        // 左上角
        RoiRelative(0.1800f, 0.1000f, 0.3800f, 0.1500f, "field_3_14|压缩机油压", "油压差"),
        RoiRelative(0.2400f, 0.1500f, 0.3600f, 0.2000f, "field_3_15|压缩机油箱温度", "油温"),
        // 右上角
        RoiRelative(0.7600f, 0.1000f, 0.9200f, 0.1500f, "field_3_16|压缩机排口温度", "压缩机出口温度"),
        RoiRelative(0.7600f, 0.1500f, 0.9200f, 0.2000f, "field_3_17|压缩机导液开度", "滑阀位置"),
        // 左中 冷却水
        RoiRelative(0.0800f, 0.3500f, 0.2000f, 0.4000f, "field_3_09|冷凝器出口水温", "冷却水温度 出水"),
        RoiRelative(0.0800f, 0.4000f, 0.2000f, 0.4500f, "field_3_08|冷凝器进口水温", "冷却水温度 返回"),
        // 右中 冷冻水
        RoiRelative(0.7600f, 0.3500f, 0.9200f, 0.4000f, "field_3_02|蒸发器出口水温", "冷冻水温度 出水"),
        RoiRelative(0.7600f, 0.4000f, 0.9200f, 0.4500f, "field_3_01|蒸发器进口水温", "冷冻水温度 返回"),
        // 底部左侧 冷凝器
        RoiRelative(0.2400f, 0.7400f, 0.4200f, 0.7900f, "field_3_12|冷凝器冷凝压力", "冷凝器压力"),
        RoiRelative(0.2400f, 0.7900f, 0.4200f, 0.8400f, "field_3_13|冷凝器冷凝温度", "冷凝器饱和温度"),
        // 底部右侧 蒸发器
        RoiRelative(0.6400f, 0.7400f, 0.9200f, 0.7900f, "field_3_05|蒸发器蒸发压力", "蒸发压力"),
        RoiRelative(0.6400f, 0.7900f, 0.9200f, 0.8400f, "field_3_06|蒸发器蒸发温度", "蒸发器饱和温度")
    )
