...
object DeviceOcrStrategy {
    ...
    private val screw1Evaporator = listOf(
        ...
        // 出水温度左边界左移，解决7被截断问题
        HardcodedRoi(0.8100f, 0.4315f, 0.1520f, 0.0280f, "field_1_02|蒸发器出口水温", "蒸发器出水温度"),
    ...
    private val screw1Compressor = listOf(
        ...
        // 主机负载：收窄宽度，仅框选第一个数值
        HardcodedRoi(0.4853f, 0.5888f, 0.1600f, 0.0305f, "field_1_18|主机负载", "%RLA"),
        // 电机电流：收窄宽度，仅框选L1数值
    ...
    private val screw1EvapRel = listOf(
        ...
        // 出水温度左边界左移，确保数字7完整在框内
        RoiRelative(0.7300f, 0.3705f, 0.9491f, 0.4218f, "field_1_02|蒸发器出口水温", "蒸发器出水温度"),
    ...
    private val screw1CondRel = listOf(
        RoiRelative(0.8295f, 0.2713f, 0.9725f, 0.3259f, "field_1_08|冷凝器进口水温", "冷凝器回水温度"),
        RoiRelative(0.8295f, 0.3719f, 0.9703f, 0.4207f, "field_1_09|冷凝器出口水温", "冷凝器出水温度"),
        RoiRelative(0.7334f, 0.5659f, 0.9675f, 0.6234f, "field_1_12|冷凝器冷媒压力", "冷凝器制冷剂压力"),
    ...
    private val screw1CompRel = listOf(
        ...
        // 主机负载：大幅收窄右边界，仅包含第一个数值
        RoiRelative(0.4764f, 0.6568f, 0.6000f, 0.7124f, "field_1_18|主机负载", "%RLA"),
        // 电机电流：大幅收窄右边界，仅包含L1数值
        RoiRelative(0.4542f, 0.7580f, 0.6000f, 0.8095f, "field_1_17|电机电流", "电流L1 L2 L3")
    )

    private val centRel = listOf(
        RoiRelative(0.8474f, 0.3619f, 0.9419f, 0.4021f, "field_1_69|蒸发器出口水温", "冷冻水温度 出水"),
        RoiRelative(0.8459f, 0.4050f, 0.9419f, 0.4410f, "field_1_68|蒸发器进口水温", "冷冻水温度 返回"),
        RoiRelative(0.7828f, 0.9045f, 0.9105f, 0.9420f, "field_1_78|蒸发器冷媒压力", "蒸发器压力"),
